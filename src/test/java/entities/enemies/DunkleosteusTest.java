...
/**
 *  Testing class for the dunkleosteus properties
 * @author Dylan
 */
public class DunkleosteusTest {
    ...
    public void getScoreScalingFactorTest() {
    	assertEquals(GameEntities.DUNKLEOSTEUS.getScoreScalingFactor(), enemy.getScoreScalingFactor(), 0);
    }
    ...
    public void getmovementSpeedScalingFactorTest() {
    	assertEquals(GameEntities.DUNKLEOSTEUS.getMovementSpeedScalingFactor(),enemy.getMovementSpeedScalingFactor(),0);
    }
