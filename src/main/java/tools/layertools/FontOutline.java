...
public class FontOutline {
     ...
     */
    public static void drawText(Graphics2D screen, GameFonts font, String text, int startX, int startY){
        drawText(screen, font.getFont(), font.getFill(), font.getOutlineColor(), font.getOutlineSize(), text, startX, startY);
    }
     ...
     * @param startY the Y coordinate of the starting position of the text.
     */
    public static void drawText(Graphics2D screen, Font font, Color fill, Color outlineColor, float outlineSize, String text, int startX, int startY){
     ...
     * @param startY the Y coordinate of the starting position of the text.
     */
    public static void drawTextHorizontallyCentered(Graphics2D screen, GameFonts font, String text, int startY){
        drawTextHorizontallyCentered(screen, font.getFont(), font.getFill(), font.getOutlineColor(), font.getOutlineSize(), text, startY);
    }
     ...
     * @param startY the Y coordinate of the starting position of the text.
     */
    public static void drawTextHorizontallyCentered(Graphics2D screen, Font font, Color fill, Color outlineColor, float outlineSize, String text, int startY){
        ...
        drawText(screen, font, fill, outlineColor, outlineSize, text, startX, startY);
    }
