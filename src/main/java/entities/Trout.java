...
public class Trout extends Enemy {
    ...
    private final static double entitywidth = 100;
    private final static double entityheight = 50;

    private final static double spritewidth = 300;
    private final static double spriteheight = 300;
    ...
    private final static double minscale = 20;
    private final static double maxscale = 100;
