...
public class Animation {
	...
	public static Animation createAnimation(String animationURL, int numberFrames, int frameWidth, int frameHeight) throws IOException{
	...
	private static BufferedImage getSubimage(BufferedImage image, int index, int startX, int startY, int frameWidth, int frameHeight){
